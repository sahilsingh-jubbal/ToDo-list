...
function Area_part() {
    ...
    function OnChangeFirst(eve) {
        ...
        var lengthOne = area(valueForFirst).from(selectFirst).to(selectSecond);
    ...
    function OnChangeSecond(eve) {
        ...
        var lengthOne = area(valueForSecond).from(selectSecond).to(selectFirst);
        console.log(lengthOne);
