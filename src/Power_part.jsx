...
function Power_part() {
    ...
    function OnChangeFirst(eve) {
        ...
        var lengthOne = power(valueForFirst).from(selectFirst).to(selectSecond);
    ...
    function OnChangeSecond(eve) {
        ...
        var lengthOne = power(valueForSecond).from(selectSecond).to(selectFirst);
        console.log(lengthOne);
