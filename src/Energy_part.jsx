...
function Energy_part() {

    var [fromFirst, setFromFirst] = useState(1);
    var [fromSecond, setFromSecond] = useState(3600);
    ...
    function OnChangeFirst(eve) {
        ...
        var lengthOne = energy(valueForFirst).from(selectFirst).to(selectSecond);
    ...
    function OnChangeSecond(eve) {
        ...
        var lengthOne = energy(valueForSecond).from(selectSecond).to(selectFirst);
        console.log(lengthOne);
